...
interface Testimonial {
  ...
  description: string;
  imageUrl: string;
  githubUrl?: string; // Optional, unused
  twitterUrl?: string; // Optional, unused
  youtubeUrl?: string; // Optional, unused
  linkedinUrl?: string; // Optional, unused
}
...
function ReviewsCarousel({ className }: TestimonialCarouselProps) {
  ...
  return (
    <div className={cn("w-full max-w-5xl mx-auto px-4", className)}>
      ...
      <div className='hidden md:flex relative items-center'>
        ...
        {/* Card */}
        <div className='bg-white/95 dark:bg-neutral-900/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 ml-[-80px] z-10 max-w-xl flex-1 border border-white/10'>
          <AnimatePresence mode='wait'>
            <motion.div
    ...
    <section className="section-padding relative">
      <div className="container-custom mb-16 text-center">
        ...
        <p className="text-xl text-neutral-400 max-w-2xl mx-auto">
          Hear from our partners about their experience working with us to achieve their digital goals.
        </p>
      </div>
      <ReviewsCarousel />
    </section>
