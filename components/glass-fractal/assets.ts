...
export type { HeroGlassAssets } from "./assets-core";

// Assets mirror the MIT-licensed vgpu Glass Fractal example from vgpu.sh.
const GLASS_MESH_URL =
  "/assets/glass-fractal/rounded-tetrahedron.mesh";
const FRACTAL_MESH_URL =
  "/assets/glass-fractal/fractal-tetrahedron-l7.mesh";
const ENVIRONMENT_URL =
  "/assets/glass-fractal/studio-cubemap-prefiltered.png";
