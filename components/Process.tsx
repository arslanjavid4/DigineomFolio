...
const steps: readonly Step[] = [
  {
    ...
    description: "We dive deep into your business goals, user needs, and market landscape to build a solid foundation for your project.",
  },
  {
    id: "2",
    name: "Step 2",
    title: "Strategic Planning",
    description: "We create a comprehensive roadmap, defining scope, milestones, and technical requirements to ensure success.",
  },
  {
    id: "3",
    name: "Step 3",
    title: "UX/UI Design",
    description: "Our designers craft intuitive and visually stunning interfaces that provide seamless user experiences.",
  },
  {
    id: "4",
    name: "Step 4",
    title: "Agile Development",
    description: "We build your solution using iterative sprints, allowing for flexibility and regular feedback.",
  },
  {
    id: "5",
    name: "Step 5",
    title: "Quality Assurance",
    description: "Rigorous testing across devices and browsers ensures your product is bug-free and performs flawlessly.",
  },
  {
    id: "6",
    name: "Step 6",
    title: "Launch & Growth",
    description: "We deploy your solution and provide ongoing support and optimization to help your business grow.",
  },
]
...
function FeatureCarousel({
  ...
  const renderStepContent = () => {
    switch (step) {
      ...
      case 5:
        return <AnimatedStepImage alt={image.alt} className={cn(defaultClasses.img, step6imgClass)} src={image.step6img} preset="fadeInScale" />
      default: return null
    }
  }
  return (
    ...
    <section className="section-padding">
      <div className="container-custom mb-16 text-center">
        ...
        <p className="text-xl text-neutral-400 max-w-2xl mx-auto">
          A proven methodology designed to deliver exceptional results throughout every stage of development.
        </p>
      </div>
